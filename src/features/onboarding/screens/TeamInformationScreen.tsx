...
export default function TeamInformationScreen({
  ...
  const handleContinue = () => {
    ...
    const updatedParams = {
      ...
      clubEnabled,
      clubOrgName: clubEnabled ? clubOrgName.trim() : '',
      clubTeamName: clubEnabled ? clubTeamName.trim() : '',
      clubCity: clubEnabled ? clubCity.trim() : '',
      clubState: clubEnabled ? clubState.trim() : '',
